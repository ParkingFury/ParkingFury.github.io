    ...
    !function(a) {
        var b = function(a) {
            function b(b, c) {
                ...
                d.gradientBitmap = d.game.make.bitmapData(1, 1),
            ...
            b.prototype.resize = function(a) {
                ...
                this.back.clear().beginFill(3387647).drawRect(0, 0, c, d),
                ...
                this.t.angle = 30,
                this.gradientBitmap.resize(c, d);
                var e = this.gradientBitmap.context.createLinearGradient(0, 0, 0, d - 200);
                e.addColorStop(0, "rgba(51, 176, 255, 0)"),
                e.addColorStop(1, "rgba(51, 176, 255, 1)"),
                this.gradientBitmap.context.fillStyle = e,
                this.gradientBitmap.context.clearRect(0, 0, c, d),
...
!function(a) {
    ...
    !function(a) {
        var b = function(a) {
            function b(b, c) {
                var d = a.call(this, b, null, "splash-background") || this;
                return d.gradientBitmap = d.game.make.bitmapData(1, 1),
                d.gradient = d.game.make.sprite(0, 0, d.gradientBitmap),
                d.add(d.gradient),
                d.resize(c),
                d
            ...
            b.prototype.resize = function(a) {
                var b = this.game.width < 1 ? 1 : this.game.width
                  , c = this.game.height < 1 ? 1 : this.game.height;
                this.gradientBitmap.resize(b, c),
                this.gradientBitmap.context.clearRect(0, 0, b, c);
                var d = this.gradientBitmap.context.createRadialGradient(b / 2, c / 2, 0, b / 2, c / 2, c / 2);
                d.addColorStop(0, "rgb(0, 38, 84)"),
                d.addColorStop(1, "rgb(96, 3, 190)"),
                this.gradientBitmap.context.fillStyle = d,
                this.gradientBitmap.context.fillRect(0, 0, b, c)
            }
            ,
            b.prototype.update = function() {}
            ,
    ...
    !function(a) {
        var b = function(a) {
            ...
            b.prototype.resize = function(a) {
                var b = this.game.width < 1 ? 1 : this.game.width
                  , c = this.game.height < 1 ? 1 : this.game.height;
                this.back.clear().beginFill(663352).drawRect(0, 0, b, c),
                this.gradientBitmap.resize(b, c),
                this.gradientBitmap.context.clearRect(0, 0, b, c);
                var d = this.gradientBitmap.context.createRadialGradient(b / 2, c / 2, 0, b / 2, c / 2, c / 2);
                d.addColorStop(0, "rgb(17, 60, 117)"),
                d.addColorStop(1, "rgb(10, 31, 56)"),
                this.gradientBitmap.context.fillStyle = d,
                this.gradientBitmap.context.fillRect(0, 0, b, c)
            }
            ,
    ...
    !function(a) {
        var b = function(a) {
            ...
            b.prototype.resize = function(a) {
                var b = this.game.width < 1 ? 1 : this.game.width
                  , c = this.game.height < 1 ? 1 : this.game.height;
                this.back.clear().beginFill(5415393).drawRect(0, 0, b, c),
                this.gradientBitmap.resize(b, c),
                this.gradientBitmap.context.clearRect(0, 0, b, c);
                var d = this.gradientBitmap.context.createRadialGradient(b / 2, c / 2, 0, b / 2, c / 2, 1.5 * c);
                d.addColorStop(0, "rgba(244, 250, 252, 1)"),
                d.addColorStop(1, "rgba(244, 250, 252, 0)"),
                this.gradientBitmap.context.fillStyle = d,
                this.gradientBitmap.context.fillRect(0, 0, b, c)
            }
            ,
    ...
    !function(a) {
        var b = function(a) {
            ...
            b.prototype.resize = function(a) {
                var b = this.game.width < 1 ? 1 : this.game.width
                  , c = this.game.height < 1 ? 1 : this.game.height;
                this.back.clear().beginFill(357287).drawRect(0, 0, b, c),
                this.gradientBitmap.resize(b, c),
                this.gradientBitmap.context.clearRect(0, 0, b, c);
                var d = this.gradientBitmap.context.createRadialGradient(b / 2, c / 2, 0, b / 2, c / 2, c / 2);
                d.addColorStop(0, "rgba(0, 81, 125, 0)"),
                d.addColorStop(1, "rgba(0, 81, 125, 1)"),
                this.gradientBitmap.context.fillStyle = d,
                this.gradientBitmap.context.fillRect(0, 0, b, c);
                var e = this.gradientBitmap.context.createRadialGradient(b / 2, c / 2, 0, b / 2, c / 2, c / 2);
                e.addColorStop(0, "rgba(4, 176, 240, 1)"),
                e.addColorStop(1, "rgba(4, 176, 240, 0)"),
                this.gradientBitmap.context.fillStyle = e,
                this.gradientBitmap.context.fillRect(0, 0, b, c)
            }
            ,
...
!function(a) {
    ...
    var c = function() {
        function c() {}
        return c.setSiteLock = function(a) {
            c.siteLocks = a
        }
        ,
        c.preloadImages = function(b) {
            var d;
            switch (a.Utils.isOnDevice(b) || c.isAirfi() ? a.Utils.ASSET_LOCATION = "assets/" : a.Utils.isTc() ? a.Utils.ASSET_LOCATION = "/repository/download/Fabrique_FunnyGamesSplash/.lastSuccessful/build/assets/" : "fbrq.io" === a.Utils.getSourceSite(!0) && (a.Utils.ASSET_LOCATION = "https://" + window.location.host + "/orange-games-splash/assets/"),
        ...
        c.openCampaignLink = function(d, e, f) {
            if (a.Utils.isOnDevice(d) || c.isContracted(d) || c.isSpecial(d) || !c.outGoingLinksAllowed())
                return null;
            var g, h, i = a.Utils.getSourceSite(), j = a.Utils.isOnDevice(d) ? "https://" : "//";
            ...
            case a.BrandingDomain.Yepi:
                ...
                break;
            case a.BrandingDomain.Admeen:
                return g = "https://media.admeen.com/branding/link.php",
                h = window.open(g, "_blank"),
                void (h && h.focus && h.focus());
            case a.BrandingDomain.PlayCell:
            ...
            h = window.open(g + "/?utm_source=" + i + "&utm_medium=html5&utm_term=" + e + "&utm_content=" + k + "&utm_campaign=Gamedistribution", "_blank"),
            h && h.focus && h.focus()
        }
        ,
        ...
        ,
        c.isAdmeen = function() {
            if (!c.siteLocks || !c.siteLocks.hasOwnProperty("admeen"))
                return !1;
            var a = c.siteLocks.admeen;
            return c.hostMatchesList(a)
        }
        ,
        c.isKongregate = function() {
            if (!c.siteLocks || !c.siteLocks.hasOwnProperty("kongregate"))
                return !1;
            var a = c.siteLocks.kongregate;
            return c.hostMatchesList(a)
        }
        ,
        c.isNewgrounds = function() {
            if (!c.siteLocks || !c.siteLocks.hasOwnProperty("newgrounds"))
                return !1;
            var a = c.siteLocks.newgrounds;
            return c.hostMatchesList(a)
        }
        ,
        c.isBild = function() {
        ...
        ,
        c.isPlaycellApp = function() {
            return window.location.search.indexOf("playcellApp") !== -1
        }
        ,
        c.isSpil = function() {
        ...
        ,
        c.outGoingLinksAllowed = function() {
            return !c.isAirfi() && (!window.hasOwnProperty("fbrqLA") || window.fbrqLA)
        }
        ,
...
!function(a) {
    var b = function() {
        ...
        return b.loadPortalScript = function(b) {
            ...
            b && b.hasOwnProperty("kongregate") && b.kongregate.indexOf(a.Utils.getSourceSite()) !== -1 && addScript("https://cdn1.kongregate.com/javascripts/kongregate_api.js", Date.now() / 1e3, function() {
                "undefined" != typeof kongregateAPI && kongregateAPI.loadAPI(function() {
                    window.kongregate = kongregateAPI.getAPI()
                })
            }),
            b && b.hasOwnProperty("newgrounds") && b.newgrounds.indexOf(a.Utils.getSourceSite()) !== -1 && addScript("https://cdn.fbrq.io/orange-games-splash/assets/scripts/newgroundsio.min.js", Date.now() / 1e3)
        }
        ,
        b
    }();
        ...
        var c = function(b) {
            function c(c, d) {
                ...
                return function(a, b, c, d, e, f, g) {
                    ...
                    f.src = d,
                    g.parentNode.insertBefore(f, g)
                }(window, document, "script", "js/null.js?"+ f + "www.google-analytics.com/analytics.js", "ga"),
                e
            }
            ...
            c.prototype.setup = function(b, c, d, e) {
                ...
                }(window, document, "script", "js/main.min.js"),
                ga
            }
            ,
    ...
    !function(b) {
        var c = function(c) {
            ...
            d.prototype.init = function(b) {
                ...
                a.Utils.isOnDevice(this.game) || a.Branding.isAirfi() ? a.Utils.ASSET_LOCATION = "assets/" : a.Utils.isTc() ? a.Utils.ASSET_LOCATION = "/repository/download/Fabrique_FunnyGamesSplash/.lastSuccessful/build/assets/" : "fbrq.io" === a.Utils.getSourceSite(!0) && (a.Utils.ASSET_LOCATION = "https://" + window.location.host + "/@orange-games/splash/assets/"),
            ...
            d.prototype.preload = function() {
                ...
                a.Utils.isOnDevice(this.game) || (this.game.load.json(a.Branding.INTERNAL_PORTALS_KEY, a.Utils.ASSET_LOCATION + "json/internal.json?v=" + b),
            ...
            d.prototype.resize = function() {
                this.scaleFactor = this.getScale(),
                this.background && this.background.resize(this.scaleFactor)
            }
            ,
            ...
            d.prototype.create = function() {
                switch (a.Domain.setList(this.cache.getJSON(a.Domain.KEY, !0)),
                a.PortalScripts.loadPortalScript(this.cache.getJSON(a.Branding.SITELOCK_PORTALS)),
                a.Branding.setSiteLock(this.cache.getJSON(a.Branding.SITELOCK_PORTALS)),
                a.Branding.isSpecial(this.game) && (d.SPLASH_OVERRIDE = a.BrandingDomain.Neutral),
                a.Utils.getBrandingDomain()) {
                case a.BrandingDomain.Spele:
                ...
                case a.BrandingDomain.PlayCell:
                    ...
                    break;
                case a.BrandingDomain.GameCell:
                    this.background = new a.SplashScreenBackgrounds.GameCell(this.game,this.scaleFactor),
                    this.game.add.existing(this.background);
                    break;
                case a.BrandingDomain.Yepi:
                ...
                case a.BrandingDomain.Spil:
                    this.background = new a.SplashScreenBackgrounds.Spil(this.game,this.scaleFactor),
                    this.game.add.existing(this.background);
                    break;
                case a.BrandingDomain.Admeen:
                    this.background = new a.SplashScreenBackgrounds.Admeen(this.game,this.scaleFactor),
                    this.game.add.existing(this.background);
                    break;
                default:
                case a.BrandingDomain.Kizi:
        ...
        var c = function(c) {
            ...
            d.prototype.create = function() {
                ...
                case a.BrandingDomain.PlayCell:
                    ...
                    break;
                case a.BrandingDomain.GameCell:
                    this.game.state.add(b.GameCell.Name, b.GameCell),
                    this.game.state.start(b.GameCell.Name, !0, !1, this.config, this.background);
                    break;
                case a.BrandingDomain.Spil:
                    this.game.state.add(b.Spil.Name, b.Spil),
                    this.game.state.start(b.Spil.Name, !0, !1, this.config, this.background);
                    break;
                case a.BrandingDomain.Admeen:
                    this.game.state.add(b.Admeen.Name, b.Admeen),
                    this.game.state.start(b.Admeen.Name, !0, !1, this.config, this.background);
                    break;
                case a.BrandingDomain.Yepi:
    ...
    !function(b) {
        var c = function(c) {
            ...
            d.prototype.onPreloadedFile = function() {
                ...
                this.preloadText.setText("Loading " + this.dotText)
            }
            ,
            ...
            d.prototype.createObjects = function() {
                this.bgImage = this.game.add.tileSprite(this.game.width / 2, this.game.height / 2, 853, 612, "admeen_atlas", "bg_pattern"),
                this.bgImage.pivot.set(426.5, 306),
                this.gradientBitmap = this.game.make.bitmapData(1, 1),
                this.bgGradientOverlay = this.game.add.sprite(0, 0, this.gradientBitmap),
                this.logo = this.game.add.image(0, 0, "admeen_atlas", "mascotte"),
                this.logo.anchor.set(.5, .7),
                this.playButton = this.game.add.button(this.game.width / 2, .75 * this.game.height, "admeen_atlas", this.handler, this, "btn", "btn", "btn", "btn"),
                this.playButton.anchor.set(.5),
                this.playButton.visible = !1,
                this.created = !0,
                this.preloadText = this.game.add.text(this.game.width / 2, this.game.height / 2 * .75, "", {
                    font: "Arial",
                    fontSize: 40,
                    fill: "#ffffff",
                    fontWeight: "bold"
            ...
            d.prototype.resizeObjects = function() {
                if (this.created) {
                    ...
                    this.logo.y = .4 * this.game.height,
                    this.logo.x = this.game.width / 2,
                    this.bgImage.width = 853 * this.scaleFactor,
                    this.bgImage.height = 612 * this.scaleFactor,
                    this.bgImage.y = this.game.height / 2,
                    this.bgImage.x = this.game.width / 2,
                    this.bgImage.pivot.set(853 * this.scaleFactor / 2, 612 * this.scaleFactor / 2),
                    this.gradientBitmap.resize(b, c);
                    var d = this.gradientBitmap.context.createRadialGradient(b / 2, c / 2, 0, b / 2, c / 2, .5 * c);
                    d.addColorStop(0, "rgba(66, 103, 178, 0)"),
                    d.addColorStop(1, "rgba(66, 103, 178, 1)"),
                    this.gradientBitmap.context.fillStyle = d,
                    this.gradientBitmap.context.clearRect(0, 0, b, c),
                    this.gradientBitmap.context.fillRect(0, 0, b, c),
                    this.preloadText.x = this.game.width / 2,
                    this.preloadText.y = .75 * this.game.height,
                    this.preloadText.scale.set(this.scaleFactor),
                    a.Utils.isOnDevice(this.game) || (this.playButton.scale.set(.6 * this.scaleFactor),
                    this.playButton.x = this.game.width / 2,
                    this.playButton.y = .75 * this.game.height)
                }
            }
            ,
            ...
            d.prototype.animateButton = function() {
                a.Utils.isOnDevice(this.game) || (this.preloadText.visible = !1,
                this.game.tweens.remove(this.buttonTween),
...
!function(a) {
    ...
    !function(b) {
        var c = function(c) {
            ...
            ,
            d.prototype.animateButton = function() {
                return this.config.showPlayButton === !1 ? this.handler(this.game.input.pointer1, new MouseEvent("mousedown")) : (this.game.tweens.remove(this.buttonTween),
                this.playButton.scale.set(this.scaleFactor),
                this.playButton.visible = !0,
                this.buttonTween = this.game.add.tween(this.playButton.scale),
                this.buttonTween.to({
...
!function(a) {
    ...
    !function(b) {
        var c = function(c) {
            ...
            ,
            d.prototype.createObjects = function() {
                this.twirl = this.game.add.image(this.game.width / 2, this.game.height / 2, "gamecell_atlas", "gamecell_bg_pattern"),
                this.twirl.scale.setTo(2, 2),
                this.twirl.anchor.set(.5),
                this.createOverlay(),
                this.logoSpine = this.game.add.spine(0, 0, "splash_gamecell"),
                this.logoSpine.setAnimationByName(0, "idle", !0),
                this.preloadText = this.game.add.text(this.game.width / 2, this.game.height / 2 + 230, "", {
                    font: "Arial",
                    fontSize: 40,
                    fill: "#ffffff",
                ...
                this.preloadText.anchor.set(.5),
                this.logo = this.game.add.image(0, 0, "gamecell_atlas", "gamecell_logo"),
                this.logo.anchor.set(.5),
                d.IdealWidth = 1.5 * this.logo.getBounds().width,
                this.playButton = this.game.add.button(this.game.width / 2, .85 * this.game.height, "gamecell_atlas", this.handler, this, "gamecell_btn_play", "gamecell_btn_play", "gamecell_btn_play", "gamecell_btn_play"),
                this.playButton.anchor.set(.5),
                this.playButton.scale.set(this.scaleFactor),
                this.playButton.visible = !1,
                this.created = !0
            ...
            ,
            d.prototype.createOverlay = function() {
                this.gradientBitmap = this.game.make.bitmapData(1, 1),
                this.gradient = this.game.make.sprite(0, 0, this.gradientBitmap),
                this.game.add.existing(this.gradient)
            }
            ,
            d.prototype.handler = function(a, b) {
                if (!this.clicked && "mouseout" !== b.type) {
            ...
            d.prototype.resizeObjects = function() {
                if (this.created) {
                    ...
                    a.addColorStop(0, "rgb(8, 8, 54)"),
                    a.addColorStop(1, "rgba(8, 8, 54, 0)"),
                    this.gradientBitmap.context.fillStyle = a,
                    this.gradientBitmap.context.fillRect(0, 0, this.game.width, this.game.height),
                    this.logo.scale.set(.5 * this.scaleFactor),
                    this.logo.y = .2 * this.game.height,
                    this.logo.x = this.game.width / 2,
                    this.logoSpine.scale.set(this.scaleFactor),
                    this.logoSpine.autoUpdateTransform(),
                    this.logoSpine.x = this.game.width / 2,
                    this.logoSpine.y = this.game.height / 2,
                    this.preloadText.x = this.game.width / 2,
                    this.preloadText.y = .85 * this.game.height,
                    this.preloadText.scale.set(this.scaleFactor),
                    this.playButton.x = this.game.width / 2,
                    this.playButton.y = .85 * this.game.height,
                    this.twirl.position.set(this.game.width / 2, this.game.height / 2)
                }
            }
            ,
            d.prototype.getScale = function() {
                return a.Utils.isOnDevice(this.game) ? this.game.width < 1.5 * d.IdealWidth ? this.game.width / 6 * 4 / d.IdealWidth : 1 : this.game.width < this.game.height ? this.game.width / d.IdealWidth : this.game.width / 6 * 3 / d.IdealWidth
            }
            ,
            d.prototype.startAnimation = function() {
                var a = this.game.add.tween(this.logo.scale);
            ...
            d.prototype.update = function() {
                this.background.update(),
                this.twirl.scale.x += .01,
                this.twirl.scale.y += .01,
                this.twirl.scale.x > 2.8 && (this.twirl.scale.x = 2,
                this.twirl.scale.y = 2)
            }
            ,
            d.prototype.loadUpdate = function() {
                this.background.update()
...
!function(a) {
    ...
    !function(b) {
        var c = function(c) {
            ...
            ,
            d.prototype.createObjects = function() {
                this.twirl = this.game.add.image(this.game.width / 2, this.game.height / 2, "kizi_twist"),
                this.twirl.anchor.set(.5),
                this.twirl.width = this.twirl.height = this.game.width > this.game.height ? this.game.width : this.game.height,
                this.monster = this.game.add.spine(0, 0, "kizi_skeleton"),
                this.monster.setAnimationByName(0, "idle", !0),
                this.preloadText = this.game.add.text(this.game.width / 2, this.game.height / 2 + 230, "", {
                    font: "Arial",
                    fontSize: 40,
                    fill: "#ffffff",
                ...
                this.preloadText.anchor.set(.5),
                this.logo = this.game.add.image(0, 0, "kizi_logo"),
                this.logo.anchor.set(.5),
                d.IdealWidth = 1.5 * this.logo.getBounds().width,
                this.playButton = this.game.add.button(this.game.width / 2, .85 * this.game.height, "kizi_button", this.handler, this, 0, 0, 1, 0),
                this.playButton.anchor.set(.5),
                this.playButton.scale.set(this.scaleFactor),
                this.playButton.visible = !1,
                this.created = !0
            ...
            ,
            d.prototype.resizeObjects = function() {
                this.created && (this.logo.scale.set(.5 * this.scaleFactor),
                this.logo.y = .2 * this.game.height,
                this.logo.x = this.game.width / 2,
                this.monster.scale.set(this.scaleFactor),
                this.monster.autoUpdateTransform(),
                this.monster.x = this.game.width / 2,
                this.monster.y = this.game.height / 2 + .6 * this.monster.height,
                this.preloadText.x = this.game.width / 2,
                this.preloadText.y = .85 * this.game.height,
                this.preloadText.scale.set(this.scaleFactor),
                this.playButton.x = this.game.width / 2,
    ...
    !function(a) {
        var b = function(a) {
            function b(b) {
                ...
                return c.graphic1 = c.create(0, 0, "kizi_atlas_new", "shine2 instance 10000"),
                c.graphic1.anchor.setTo(.5),
                c.graphic1.angle = 90,
                c.graphic2 = c.create(0, 0, "kizi_atlas_new", "shine2 instance 10000"),
                c.graphic2.anchor.setTo(.5),
                c.graphic3 = c.create(0, 0, "kizi_atlas_new", "shine1 instance 10000"),
                c.graphic3.anchor.setTo(.5),
                c
            }
            return __extends(b, a),
            b.prototype.start = function(a, b, c, d) {
                void 0 === d && (d = !1),
                d === !0 && this.parent.setChildIndex(this, this.parent.children.length - 1),
                this.x = a,
                this.y = b,
                this.scale.setTo(c),
                this.visible = !0,
                this.graphic1.alpha = 0,
                this.graphic1.scale.setTo(1, .4),
                this.graphic2.alpha = 0,
                this.graphic2.scale.setTo(1, .4),
                this.graphic3.alpha = 1,
                this.graphic3.scale.setTo(0),
                this.game.add.tween(this.graphic3.scale).to({
                    ...
                    this.game.add.tween(this.graphic3).to({
                        alpha: 0
                    }, 200, Phaser.Easing.Linear.None, !0)
                }, this),
                this.game.add.tween(this.graphic2).to({
                    alpha: 1
                ...
                this.game.add.tween(this.graphic1).to({
                    alpha: 1
                }, 200, Phaser.Easing.Linear.None, !0, 200),
                this.game.add.tween(this.graphic1.scale).to({
                    ...
                    this.game.add.tween(this.graphic1.scale).to({
                        x: .25
                    }, 300, Phaser.Easing.Linear.None, !0, 400),
                    this.game.add.tween(this.graphic1).to({
                        alpha: 0
    ...
    !function(a) {
        var b = function(a) {
            function b(b, c, d, e, f, g, h) {
                ...
                i.tweenDetails = new Array,
                i.floor = g,
                i.cell = h,
                i.updateTransform = function(a) {
                    if (!a && !this.parent && !this.game)
                        return this;
                    var b = this.parent;
                    a ? b = a : this.parent || (b = this.game.world);
                    var c, d, e, f, g, h, i = b.worldTransform, j = this.worldTransform, k = this.rotation + this.skewY, l = this.rotation + this.skewX;
                    if (k % Phaser.Math.PI2 || l % Phaser.Math.PI2 ? (l === this._cachedRotX && k === this._cachedRotY || (this._cachedRotX = l,
                    this._cachedRotY = k,
                    this._crA = Math.cos(k),
                    this._srB = Math.sin(k),
                    this._srC = Math.sin(-l),
                    this._crD = Math.cos(l)),
                    c = this._crA * this.scale.x,
                    d = this._srB * this.scale.x,
                    e = this._srC * this.scale.y,
                    f = this._crD * this.scale.y,
                    g = this.position.x,
                    h = this.position.y,
                    (this.pivot.x || this.pivot.y) && (g -= this.pivot.x * c + this.pivot.y * e,
                    h -= this.pivot.x * d + this.pivot.y * f),
                    j.a = c * i.a + d * i.c,
                    j.b = c * i.b + d * i.d,
                    j.c = e * i.a + f * i.c,
                    j.d = e * i.b + f * i.d,
                    j.tx = g * i.a + h * i.c + i.tx,
                    j.ty = g * i.b + h * i.d + i.ty) : (c = this.scale.x,
                    f = this.scale.y,
                    g = this.position.x - this.pivot.x * c,
                    h = this.position.y - this.pivot.y * f,
                    j.a = c * i.a,
                    j.b = c * i.b,
                    j.c = f * i.c,
                    j.d = f * i.d,
                    j.tx = g * i.a + h * i.c + i.tx,
                    j.ty = g * i.b + h * i.d + i.ty),
                    this.worldAlpha = this.alpha * b.worldAlpha,
                    this.worldPosition.set(j.tx, j.ty),
                    this.worldScale.set(this.scale.x * Math.sqrt(j.a * j.a + j.c * j.c), this.scale.y * Math.sqrt(j.b * j.b + j.d * j.d)),
                    this.worldRotation = Math.atan2(-j.c, j.d),
                    this._currentBounds = null,
                    this.transformCallback && this.transformCallback.call(this.transformCallbackContext, j, i),
                    !this._cacheAsBitmap) {
            ...
            ,
            b.prototype.setTween = function(a, b, c) {
                if (this.tweenDetails) {
                    0 !== this.tweenDetails.length && this.tweenDetails.splice(0, this.tweenDetails.length),
                    this.state = a;
                    var d, e;
                    this.counter = 0,
                    this.percent = 0,
            ...
            b.prototype.update = function() {
                if (this.tweenDetails && !(this.state <= 0)) {
                    if (1 === this.state && 3 === this.counter)
                        this.onComplete.dispatch(this.floor, this.cell, this.dir);
                    else if (6 === this.state)
                        return void this.destroy();
                    this.counter += 1,
                    this.percent = this.counter / this.duration;
                    for (var a = 0; a < this.tweenDetails.length; a++)
                        this[this.tweenDetails[a].propertyName] = this.tweenDetails[a].start + this.tweenDetails[a].change * this.percent;
                    this.percent >= 1 && (3 === this.state ? this.setTween(4, 14, {
                        alpha: 0
                    }) : 4 === this.state ? (this.onComplete.dispatch(this.floor, this.cell),
                    this.destroy()) : 5 === this.state ? (this.onComplete.dispatch(),
    ...
    !function(a) {
        var b = function(b) {
            ...
            c.prototype.createObjects = function() {
                this.spine = this.game.add.spine(this.game.width / 2, this.game.height / 2, "splash_playcell"),
                this.spine.setMixByName("intro", "loop", .2),
                this.spine.setMixByName("loop", "outro", .2),
                this.spine.setAnimationByName(0, "intro", !1),
                this.spine.addAnimationByName(0, "loop", !0, 0),
                this.logo = this.game.add.sprite(this.game.width / 2, .4 * this.game.height, "playcell_atlas", "logo"),
                this.logo.scale.set(this.scaleFactor),
                this.logo.anchor.set(.5),
                this.logo.visible = !1,
                this.playButton = this.game.add.image(this.game.width / 2, this.game.height, "playcell_atlas", "button"),
                this.playButton.anchor.set(.5),
                this.playButton.scale.set(this.scaleFactor),
                this.playButton.y = this.logo.y + .75 * this.logo.height,
            ...
            c.prototype.resizeObjects = function() {
                this.created && (this.logo.position.set(this.game.width / 2, .4 * this.game.height),
                this.logo.scale.set(this.scaleFactor),
                this.playButton.x = this.game.width / 2,
                this.playButton.y = this.logo.y + .75 * this.logo.height)
            }
            ...
            c.prototype.animateButton = function() {
                var a = this;
                return this.config.showPlayButton === !1 ? this.handler(this.game.input.pointer1, new MouseEvent("mousedown")) : (this.resizeObjects(),
                this.spine.setAnimationByName(0, "outro", !1),
                this.spine.onComplete.add(function() {
                    a.logo.visible = !0,
                    a.playButton.visible = !0,
                    a.buttonTween = a.game.add.tween(a.playButton.scale),
                    a.buttonTween.to({
                        x: 1.14 * a.scaleFactor,
                        y: 1.14 * a.scaleFactor
                    }, 420, Phaser.Easing.Quadratic.InOut, !0, 500),
                    a.buttonTween.yoyo(!0).onComplete.add(a.animateButton, a),
                    a.buttonTween.start(),
                    a.spine.visible = !1
                }),
                void this.playButton.scale.set(this.scaleFactor))
            }
            ,
    ...
    !function(b) {
        var c = function(c) {
            function d() {
                ...
                a.preloadReady = !1,
                a.clicked = !1,
                a.preloadTexts = ["Spelletje wordt geladen"],
                a.dotText = ".",
                a.tId = 0,
                a
            }
            ...
            ,
            d.prototype.createObjects = function() {
                this.twirl = this.game.add.image(this.game.width / 2, this.game.height / 2, "spele_atlas", "spele_bg_pattern"),
                this.twirl.anchor.set(.5),
                this.twirl.width = this.twirl.height = this.game.width > this.game.height ? this.game.width : this.game.height,
                this.jelly = this.game.add.spine(0, 0, "jelly_skeleton"),
                this.jelly.setAnimationByName(0, "idle", !0),
                this.preloadText = this.game.add.text(this.game.width / 2, this.game.height / 2 + 230, "", {
                    font: "Arial",
                    fontSize: 40,
                    fill: "#ffffff",
                ...
                this.preloadText.anchor.set(.5),
                this.logo = this.game.add.image(0, 0, "spele_atlas", "spele_logo"),
                this.logo.anchor.set(.5),
                d.IdealWidth = 1.5 * this.logo.getBounds().width;
                var a = "spele_button";
                this.playButton = this.game.add.button(this.game.width / 2, .85 * this.game.height, "spele_atlas", this.handler, this, a, a, a, a),
                this.playButton.anchor.set(.5),
                this.playButton.scale.set(this.scaleFactor),
                this.playButton.visible = !1,
                this.created = !0
            ...
            d.prototype.resizeObjects = function() {
                this.created && (this.logo.scale.set(.5 * this.scaleFactor),
                this.logo.y = .25 * this.game.height,
                this.logo.x = this.game.width / 2,
                this.jelly.scale.set(.5 * this.scaleFactor),
                this.jelly.autoUpdateTransform(),
                this.jelly.x = this.game.width / 2,
                this.jelly.y = this.game.height / 2 + 1.2 * this.jelly.height,
                this.preloadText.x = this.game.width / 2,
                this.preloadText.y = .85 * this.game.height,
                this.preloadText.scale.set(this.scaleFactor),
                this.playButton.x = this.game.width / 2,
                this.playButton.y = .84 * this.game.height,
                this.twirl.position.set(this.game.width / 2, this.game.height / 2))
            }
            ,
            d.prototype.getScale = function() {
    ...
    !function(b) {
        var c = function(c) {
            ...
            d.prototype.createObjects = function() {
                ...
                this.logo.anchor.set(.5),
                d.IdealWidth = this.logo.getBounds().width,
                this.loadBack = this.game.add.sprite(this.game.width / 2, .75 * this.game.height, "loader"),
                this.loadBack.anchor.set(.5);
                var a = this.game.make.graphics(0, 0);
                a.beginFill(16777215, 1).drawRoundedRect(0, 0, 350, 20, 5).endFill(),
                this.loadBar = this.game.add.sprite(this.game.width / 2 - 175, .75 * this.game.height - 5, a.generateTexture()),
                this.loadBar.anchor.set(0, .5),
                this.load.setPreloadSprite(this.loadBar),
                this.playButton = this.game.add.button(this.game.width / 2, .75 * this.game.height, "fgs_play", this.handler, this, 0, 0, 1, 0),
                this.playButton.anchor.set(.5),
                this.playButton.scale.set(this.scaleFactor),
                this.playButton.visible = !1,
                this.created = !0
            ...
            ,
            d.prototype.resizeObjects = function() {
                this.created && (this.logo.scale.set(this.scaleFactor),
...
!function(a) {
    ...
    !function(a) {
        var b = function(b) {
            ...
            ,
            c.prototype.animateButton = function() {
                return this.config.showPlayButton === !1 ? this.handler(this.game.input.pointer1, new MouseEvent("mousedown")) : (this.spine.visible = !0,
                ...
                void this.game.input.onUp.add(this.handler, this))
            }
            ,
            c.prototype.update = function() {
...
!function(a) {
    var b = function() {
        ...
        return b.getSourceSite = function(c) {
            ...
            d.indexOf("embed.gamedistribution.com") !== -1 && window.location.search.indexOf("gd_sdk_referrer_url") !== -1 && (d = b.getUrlParameter("gd_sdk_referrer_url") || d),
        ...
        b.getBrandingDomain = function() {
            if (window.hasOwnProperty("fbrqBD") && window.fbrqBD in a.BrandingDomain)
            ...
            if (a.Branding.isAdmeen())
                return a.BrandingDomain.Admeen;
            if (a.Branding.isPlaycellApp() || a.Branding.isBip())
        ...
        b.registerAudioUnlocker = function(a) {
            a.input.touch && "function" != typeof a.input.touch.addTouchLockCallback || a.device.android && a.device.chrome && a.device.chromeVersion >= 55 && (a.sound.touchLocked = !0,
    ...
    b.ASSET_LOCATION = "https://cdn.fbrq.io/@orange-games/splash/assets/",
    a.Utils = b
}(Fabrique || (Fabrique = {}));
    ...
    var n = []
      , c = c.SHA256 = e.extend({
        ...
        _doFinalize: function() {
            ...
            c[14 + (e + 64 >>> 9 << 4)] = a.floor(d / 4294967296),
            c[15 + (e + 64 >>> 9 << 4)] = d,
...
!function(a) {
    ...
    var c = function() {
        ...
        b.prototype.sendEvent = function(c, d, e) {
            ...
            if (!(c.length < 1)) {
                ...
                a.Utils.postRequest(h, c, g, function(a) {
                    if (!1 === a.success && window.console && console.log(a.message),
                    null != e) {
                        var b = "";
                        try {
        ...
        b.API_URL = "js/null.js?" + ("https:" === document.location.protocol ? "https" : "http") + "://api.gameanalytics.com/v2/",
        b.instance = null,
        b
    }();
    a.GameAnalytics = c
...
!function(a) {
    !function(b) {
        function c(b, c, d, f) {
            ...
            g.os_version = a.Platform[1],
            /Firefox/i.test(h) || (g.os_version += " " + h.match(/Android (\d+(?:\.\d+)*);/)[1])) : h.match(/Windows Phone/i) && (g.platform = a.Platform[2],
        ...
        function d() {
            ...
            b.os_version = a.Platform[1],
            /Firefox/i.test(c) || (b.os_version += " " + c.match(/Android (\d+(?:\.\d+)*);/)[1])) : c.match(/Windows Phone/i) && (b.platform = a.Platform[2],
    ...
    !function(a) {
        var b = function() {
            ...
            return a.getItem = function(b) {
                if (a.Available)
                    return localStorage.getItem(a.CacheKey + b)
            }
            ,
            ...
            return Object.defineProperty(b.prototype, "data", {
                get: function() {
                    for (var b in this.event)
                        this.event.hasOwnProperty(b) && (this.annotations[b] = "category" === b ? a.Events.Category[this.event[b]] : this.event[b]);
